...
export type PrintButtonProps = React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>;

const PrintButton= forwardRef<HTMLButtonElement, PrintButtonProps>(function SetRefPrintButton( {className, children}, ref) {
  return (
