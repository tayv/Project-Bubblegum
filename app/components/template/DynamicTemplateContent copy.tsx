...
// This component uses react context and requires page.tsx to be wrapped in a PageContext.Provider
// Decommissioned this in favour of refactoring component to use react hook form's useWatch instead