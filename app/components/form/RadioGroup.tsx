...
const radioGroupItemMap: { [key in RadioGroupVariant]: string } = {
  standard:
    "flex items-center relative w-6 h-6 rounded-full data-[state=checked]:text-cta-500",
  horizontal:
    "flex w-6 h-6 items-center relative rounded-full data-[state=checked]:text-cta-500",
  button: [
    "px-2 py-2 w-full max-w-xs ",
    "text-left text-slate-500 data-[state=checked]:text-white ",
    "border-1 border-slate-500 data-[state=checked]:border-cta-400 rounded-xl ",
    "shadow data-[state=checked]:shadow-sm data-[state=checked]:shadow-cta-500/50 shadow-slate-400 ",
    "data-[state=checked]:bg-cta-500 data-[state=unchecked]:hover:bg-slate-200 ",
  ].join(" "),
  buttonLarge: [
    "justify-center items-center flex-col gap-2 w-28 h-28 ",
    "text-slate-500 data-[state=checked]:text-white ",
    "border border-slate-300 data-[state=checked]:border-cta-400 rounded-3xl bg-white ",
    "shadow-md data-[state=checked]:shadow-lg data-[state=checked]:shadow-cta-500/50 shadow-slate-400 ",
    "data-[state=checked]:bg-cta-500 data-[state=unchecked]:hover:bg-slate-200 ",
  ].join(" "),
}
        ...
        (
          ...
          return (
            <RadixRadioGroup.Item
              ...
              className={classNames([
                [
                  ...
                  "focus-visible:ring-cta-500 focus-visible:ring-opacity-75 focus-visible:ring-offset-2 ",
                ].join(" "),
            ...
            >
              <RadixRadioGroup.Indicator
                className={classNames([
                  [
                    ...
                    "bg-slate-200 data-[state=checked]:border-cta-500 border-[3px] border-slate-300 ",
              ...
              >
                <div className="w-2.5 h-2.5 rounded-full bg-cta-500"></div>
              </RadixRadioGroup.Indicator>
