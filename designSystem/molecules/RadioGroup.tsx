...
type RadioGroupType = "standard" | "horizontal" | "button" | "buttonLarge"
...
const radioGroupIconMap: { [key in RadioGroupType]: string } = {
  standard: "hidden",
  horizontal: "hidden",
  button: "",
        ...
        (
          ...
          return (
            ...
            >
              ...
              {!!option.icon // check since not all radio types have icons
                ? option.icon
