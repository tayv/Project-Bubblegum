        ...
        <span key={index}>
          ...
          { 
            ...
            : (
              ...
              <Link href={crumb.path} className="inline no-underline text-sm text-pink-500 hover:decoration-dashed underline-offset-4 hover:text-pink-600 focus:text-pink-600">
                {crumb.text}
              </Link>
            )
          } 
