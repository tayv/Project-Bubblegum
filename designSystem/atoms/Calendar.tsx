  ...
  const setYearRange = (startYearRange: number, endYearRange: number) => {
    ...
    return yearRangeUnformatted.map((year, yearID) => {
      ...
      return (
        ...
        <Select.Item
          key={yearFormatted.toString()}
          className="outline-none cursor-pointer hover:bg-indigo-200 px-2 rounded-md"
          value={yearFormatted}
        >
          ...
          <div className="md:grid md:grid-cols-auto grid-flow-col md:divide-x md:divide-gray-200 ">
            <div className="md:pt-4 md:pr-8 md:pb-2 md:pl-6">
              <div className="flex items-center">
                <h2 className="flex-auto font-semibold text-gray-900">
                  ...
                  <Select.Root
                    value={format(firstDaySelectedMonth, "yyyy")}
                    defaultValue={format(firstDaySelectedMonth, "yyyy")}
            ...
            <section className="border-t border-neutral-200 md:border-t-0 mt-4 md:mt-0 md:px-8 md:pt-4 sm:pt-2 sm:pl-0  ">
              ...
              <ol className="grid grid-cols-2 mt md:grid-cols-none">
                <li className="text-indigo-500 py-px ">
                  <button
                    type="button"
                ...
                <li className="text-indigo-500 py-px">
                  <button type="button" onClick={() => jumpToDate(6)}>
                    + 6 months
                  </button>
                </li>
                <li className="text-indigo-500 py-px">
                  <button type="button" onClick={() => jumpToDate(12)}>
                    + 1 year
                  </button>
                </li>
                <li className="text-indigo-500 py-px">
                  <button type="button" onClick={() => jumpToDate(24)}>
                    + 2 years
                  </button>
                </li>
              </ol>
