...
const sectionStyleMap: {[key in SectionStyle]: string} = {
  standard: "bg-white drop-shadow", // css styles go here
  blank: "bg-transparent",
  special: "bg-blue-100 drop-shadow",
}   
...
const Section = (
  ...
  return (
    <section id={id} 
      className={
        classNames([
          "mt-4 p-4 rounded-xl", // standard css styles go here. Peer is always required for label styling to work
