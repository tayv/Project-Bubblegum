...
const SideNav: FC<SideNavProps> = ({
  ...
  return (
    <nav className="flex flex-col w-64 min-w-fit m-4 px-4 pt-3 rounded-3xl backdrop-blur-lg bg-white/30 border border-white/20 drop-shadow-md" aria-label="Sidebar">
      <div>
